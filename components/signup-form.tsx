...
import { Lock, Mail, Eye, EyeOff, User, Sparkles } from "lucide-react"
            ...
            >
                <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8 shadow-2xl backdrop-blur-sm">
                    ...
                    <div className="text-center mb-8">
                        ...
                        >
                            <Sparkles className="w-8 h-8 text-[#69E300]" />
                        </motion.div>
                        <h1 className="text-3xl font-bold text-white mb-2">Create Account</h1>
                        <p className="text-gray-400 text-sm">Join the Ghostwriter platform today</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-start gap-2 text-sm">
                            <input
                                type="checkbox"
                                id="terms"
                                className="w-4 h-4 mt-0.5 rounded border-zinc-700 bg-zinc-800/50 text-[#69E300] focus:ring-[#69E300]"
                                required
                            />
                            <label htmlFor="terms" className="text-gray-400 cursor-pointer">
                                I agree to the{" "}
                                <Link href="/terms" className="text-[#69E300] hover:text-[#7fff00] transition-colors">
                                    Terms of Service
                                </Link>{" "}
                                and{" "}
                                <Link href="/privacy" className="text-[#69E300] hover:text-[#7fff00] transition-colors">
                                    Privacy Policy
                                </Link>
                            </label>
                        </div>
